...
import com.example.startcms.startcms.Repository.ContenidoRepository;
...
@RestController
@RequestMapping(value = "/api/v1/contenido")
public class ContenidoRestController {
    ...
    @GetMapping
    public ResponseEntity<List<Contenido>> finAll(SpringDataWebProperties.Pageable pageable){
        return ResponseEntity.ok(repository.findAll(pageable));
    }

    @GetMapping("/{id}")
    public ResponseEntity<Contenido> finById(@PathVariable int id){
