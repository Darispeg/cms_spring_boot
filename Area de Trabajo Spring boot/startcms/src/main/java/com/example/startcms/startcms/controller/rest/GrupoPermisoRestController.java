...
import com.example.startcms.startcms.Repository.GrupoPermisoRepository;
...
@RestController
@RequestMapping(value = "/api/v1/grupopermiso")
public class GrupoPermisoRestController {
    ...
    @GetMapping
    public ResponseEntity<List<GrupoPermiso>> finAll(SpringDataWebProperties.Pageable pageable){
        return ResponseEntity.ok(repository.findAll(pageable));
    }

    @GetMapping("/{id}")
    public ResponseEntity<GrupoPermiso> finById(@PathVariable int id){
